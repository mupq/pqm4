skip_list = [
    ...
    {'scheme': 'cross-rsdp-1-balanced', 'implementation': 'm4opt', 'estmemory': 28672},
    {'scheme': 'cross-rsdp-1-balanced', 'implementation': 'm4speed', 'estmemory': 231424},
    {'scheme': 'cross-rsdp-1-balanced', 'implementation': 'm4stack', 'estmemory': 24576},
    {'scheme': 'cross-rsdp-1-balanced', 'implementation': 'ref', 'estmemory': 226304},
    {'scheme': 'cross-rsdp-1-fast', 'implementation': 'm4opt', 'estmemory': 33792},
    {'scheme': 'cross-rsdp-1-fast', 'implementation': 'm4speed', 'estmemory': 142336},
    {'scheme': 'cross-rsdp-1-fast', 'implementation': 'm4stack', 'estmemory': 28672},
    {'scheme': 'cross-rsdp-1-fast', 'implementation': 'ref', 'estmemory': 138240},
    {'scheme': 'cross-rsdp-1-small', 'implementation': 'm4opt', 'estmemory': 29696},
    {'scheme': 'cross-rsdp-1-small', 'implementation': 'm4speed', 'estmemory': 442368},
    {'scheme': 'cross-rsdp-1-small', 'implementation': 'm4stack', 'estmemory': 25600},
    {'scheme': 'cross-rsdp-1-small', 'implementation': 'ref', 'estmemory': 437248},
    {'scheme': 'cross-rsdp-3-balanced', 'implementation': 'm4opt', 'estmemory': 57344},
    {'scheme': 'cross-rsdp-3-balanced', 'implementation': 'm4speed', 'estmemory': 506880},
    {'scheme': 'cross-rsdp-3-balanced', 'implementation': 'm4stack', 'estmemory': 47104},
    {'scheme': 'cross-rsdp-3-balanced', 'implementation': 'ref', 'estmemory': 496640},
    {'scheme': 'cross-rsdp-3-fast', 'implementation': 'm4opt', 'estmemory': 66560},
    {'scheme': 'cross-rsdp-3-fast', 'implementation': 'm4speed', 'estmemory': 312320},
    {'scheme': 'cross-rsdp-3-fast', 'implementation': 'm4stack', 'estmemory': 57344},
    {'scheme': 'cross-rsdp-3-fast', 'implementation': 'ref', 'estmemory': 303104},
    {'scheme': 'cross-rsdp-3-small', 'implementation': 'm4opt', 'estmemory': 56320},
    {'scheme': 'cross-rsdp-3-small', 'implementation': 'm4speed', 'estmemory': 736256},
    {'scheme': 'cross-rsdp-3-small', 'implementation': 'm4stack', 'estmemory': 47104},
    {'scheme': 'cross-rsdp-3-small', 'implementation': 'ref', 'estmemory': 727040},
    {'scheme': 'cross-rsdp-5-balanced', 'implementation': 'm4opt', 'estmemory': 96256},
    {'scheme': 'cross-rsdp-5-balanced', 'implementation': 'm4speed', 'estmemory': 900096},
    {'scheme': 'cross-rsdp-5-balanced', 'implementation': 'm4stack', 'estmemory': 79872},
    {'scheme': 'cross-rsdp-5-balanced', 'implementation': 'ref', 'estmemory': 883712},
    {'scheme': 'cross-rsdp-5-fast', 'implementation': 'm4opt', 'estmemory': 114688},
    {'scheme': 'cross-rsdp-5-fast', 'implementation': 'm4speed', 'estmemory': 558080},
    {'scheme': 'cross-rsdp-5-fast', 'implementation': 'm4stack', 'estmemory': 98304},
    {'scheme': 'cross-rsdp-5-fast', 'implementation': 'ref', 'estmemory': 540672},
    {'scheme': 'cross-rsdp-5-small', 'implementation': 'm4opt', 'estmemory': 94208},
    {'scheme': 'cross-rsdp-5-small', 'implementation': 'm4speed', 'estmemory': 1402880},
    {'scheme': 'cross-rsdp-5-small', 'implementation': 'm4stack', 'estmemory': 77824},
    {'scheme': 'cross-rsdp-5-small', 'implementation': 'ref', 'estmemory': 1386496},
    {'scheme': 'cross-rsdpg-1-balanced', 'implementation': 'm4opt', 'estmemory': 20480},
    {'scheme': 'cross-rsdpg-1-balanced', 'implementation': 'm4speed', 'estmemory': 177152},
    {'scheme': 'cross-rsdpg-1-balanced', 'implementation': 'm4stack', 'estmemory': 18432},
    {'scheme': 'cross-rsdpg-1-balanced', 'implementation': 'ref', 'estmemory': 168960},
    {'scheme': 'cross-rsdpg-1-fast', 'implementation': 'm4opt', 'estmemory': 21504},
    {'scheme': 'cross-rsdpg-1-fast', 'implementation': 'm4speed', 'estmemory': 98304},
    {'scheme': 'cross-rsdpg-1-fast', 'implementation': 'm4stack', 'estmemory': 20480},
    {'scheme': 'cross-rsdpg-1-fast', 'implementation': 'ref', 'estmemory': 93184},
    {'scheme': 'cross-rsdpg-1-small', 'implementation': 'm4opt', 'estmemory': 21504},
    {'scheme': 'cross-rsdpg-1-small', 'implementation': 'm4speed', 'estmemory': 335872},
    {'scheme': 'cross-rsdpg-1-small', 'implementation': 'm4stack', 'estmemory': 20480},
    {'scheme': 'cross-rsdpg-1-small', 'implementation': 'ref', 'estmemory': 321536},
    {'scheme': 'cross-rsdpg-3-balanced', 'implementation': 'm4opt', 'estmemory': 38912},
    {'scheme': 'cross-rsdpg-3-balanced', 'implementation': 'm4speed', 'estmemory': 279552},
    {'scheme': 'cross-rsdpg-3-balanced', 'implementation': 'm4stack', 'estmemory': 35840},
    {'scheme': 'cross-rsdpg-3-balanced', 'implementation': 'ref', 'estmemory': 267264},
    {'scheme': 'cross-rsdpg-3-fast', 'implementation': 'm4opt', 'estmemory': 40960},
    {'scheme': 'cross-rsdpg-3-fast', 'implementation': 'm4speed', 'estmemory': 211968},
    {'scheme': 'cross-rsdpg-3-fast', 'implementation': 'm4stack', 'estmemory': 38912},
    {'scheme': 'cross-rsdpg-3-fast', 'implementation': 'ref', 'estmemory': 200704},
    {'scheme': 'cross-rsdpg-3-small', 'implementation': 'm4opt', 'estmemory': 37888},
    {'scheme': 'cross-rsdpg-3-small', 'implementation': 'm4speed', 'estmemory': 499712},
    {'scheme': 'cross-rsdpg-3-small', 'implementation': 'm4stack', 'estmemory': 34816},
    {'scheme': 'cross-rsdpg-3-small', 'implementation': 'ref', 'estmemory': 477184},
    {'scheme': 'cross-rsdpg-5-balanced', 'implementation': 'm4opt', 'estmemory': 63488},
    {'scheme': 'cross-rsdpg-5-balanced', 'implementation': 'm4speed', 'estmemory': 487424},
    {'scheme': 'cross-rsdpg-5-balanced', 'implementation': 'm4stack', 'estmemory': 57344},
    {'scheme': 'cross-rsdpg-5-balanced', 'implementation': 'ref', 'estmemory': 466944},
    {'scheme': 'cross-rsdpg-5-fast', 'implementation': 'm4opt', 'estmemory': 69632},
    {'scheme': 'cross-rsdpg-5-fast', 'implementation': 'm4speed', 'estmemory': 370688},
    {'scheme': 'cross-rsdpg-5-fast', 'implementation': 'm4stack', 'estmemory': 64512},
    {'scheme': 'cross-rsdpg-5-fast', 'implementation': 'ref', 'estmemory': 352256},
    {'scheme': 'cross-rsdpg-5-small', 'implementation': 'm4opt', 'estmemory': 61440},
    {'scheme': 'cross-rsdpg-5-small', 'implementation': 'm4speed', 'estmemory': 829440},
    {'scheme': 'cross-rsdpg-5-small', 'implementation': 'm4stack', 'estmemory': 55296},
    {'scheme': 'cross-rsdpg-5-small', 'implementation': 'ref', 'estmemory': 795648},
