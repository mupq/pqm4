...
*              polynomials before number theoretic transform 
************************************************************/
static int16_t bitrev_table [512] = {
...
*
* Arguments:   - int16_t* poly: pointer to in/output polynomial
**************************************************/
...
*              - const int16_t* omega: pointer to input powers of root of unity omega;
*                                       assumed to be in Montgomery domain
**************************************************/
void ntt(int16_t * a, const int16_t* omega)
{
  asm_ntt512(a, omega);
}
