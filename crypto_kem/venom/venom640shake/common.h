...
int mul_add_as_plus_e(uint16_t *out, const uint16_t *s, const uint8_t *seed_A); //matrix_shake
int mul_add_sa_plus_e(uint16_t *out, const uint16_t *s, const uint8_t *seed_A);
void sample_n(uint16_t *s, size_t n);   //noise
void mul_bs(uint16_t *out, const uint16_t *b, const uint16_t *s);   // util
