...
#define _p 960 // for jumpdivsteps
#define reverse_head (p-1+15)

extern int jump1920divsteps_mod3_128(int minusdelta, uint32_t *M, uint32_t *f, uint32_t *g);
...
int R3_recip_jumpdivsteps(int8_t* H, int8_t* G){
    ...
    minusdelta = jump1920divsteps_mod3_128(minusdelta,(uint32_t*)M,(uint32_t*)f,(uint32_t*)g);
