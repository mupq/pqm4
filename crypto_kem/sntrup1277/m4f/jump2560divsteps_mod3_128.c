...
int jump2560divsteps_mod3_128(int minusdelta, uint32_t *M, uint32_t *f, uint32_t *g);

extern void __update_fg_128x1280(uint32_t *f, uint32_t *g, uint32_t *M1);
...
extern void __update_VS_128x1152(uint32_t *V, uint32_t *S, uint32_t *M1);
extern void __update_VS_128x1280(uint32_t *V, uint32_t *S, uint32_t *M1);
extern void __update_VS_128x1296(uint32_t *V, uint32_t *S, uint32_t *M1);
extern void __update_fg_128x1152(uint32_t *f, uint32_t *g, uint32_t *M1);
