...
extern int jump1024divsteps_mod3_64(int minusdelta, uint32_t *M, uint32_t *f, uint32_t *g);
...
void poly_S3_inv_jumpdivsteps(poly *r, const poly *a){
    ...
    minusdelta = jump1024divsteps_mod3_64(minusdelta,(uint32_t*)M,(uint32_t*)f,(uint32_t*)g);
