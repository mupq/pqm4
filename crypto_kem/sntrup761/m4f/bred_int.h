...
__attribute__(( always_inline )) static inline int bred_16x2(int C, int Q, int QI)
{
  int result;							\
...
__attribute__(( always_inline )) static inline int bround_16x2(int C, int Q, int QII)
{									
  int scratch1;							\
  __asm__ volatile ( "smlawt	%1, %2, %0, %4\n\t"			\
		     "smultb	%1, %1, %3 \n\t"			\
