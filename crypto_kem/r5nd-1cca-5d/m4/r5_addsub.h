...
//  only used in r5_matmul.c
PQS_OLOCAL void r5_modq_addsub3_perm_nbar_d(modq_t * dst,
											const uint16_t * perm,
											const modq_t * p_add1,
											const modq_t * p_sub1,
											const modq_t * p_add2,
...
PQS_OLOCAL void r5_armv7_addsub16(uint16_t * dst, size_t n,
								  const uint16_t * p_add,
								  const uint16_t * p_sub);
...
PQS_OLOCAL void r5_armv7_addsub16_3(uint16_t * dst, size_t n,
									const uint16_t * p_add1,
									const uint16_t * p_sub1,
									const uint16_t * p_add2,
									const uint16_t * p_sub2,
									const uint16_t * p_add3,
									const uint16_t * p_sub3);
