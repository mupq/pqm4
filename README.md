...
| ntru-kem-743 (10 executions) | ref | AVG: 59,836,091 <br /> MIN: 59,710,097 <br /> MAX: 59,947,122 |  AVG: 7,536,021 <br /> MIN: 7,516,541 <br /> MAX: 7,555,098 | AVG: 14,225,718 <br /> MIN: 14,210,982 <br /> MAX: 14,243,546 |
...
| ntru-kem-743 | ref | 14,148 |  13,372 | 18,028 |
...
* the files under `crypto_kem/ntru-kem-743/` are in the [public domain](https://raw.githubusercontent.com/NTRUOpenSourceProject/NTRUEncrypt/master/LICENSE);
