...
#define polyfix_sub HAETAE_NAMESPACE(polyfix_sub)
...
void polyfixfixvecl_sub(polyfixvecl *w, const polyfixvecl *u,
                        const polyfixvecl *v);
#define polyfix_double HAETAE_NAMESPACE(polyfix_double)
...
#define polyfix_sqnorm2 HAETAE_NAMESPACE(polyfix_sqnorm2)
