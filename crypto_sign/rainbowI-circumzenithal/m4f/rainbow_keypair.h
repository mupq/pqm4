...
/// @param[in]  gf16mul   - lookup table for gf16 multiplication
///
void rainbow_evaluate_cpk_leaktime( uint32_t *z, const cpk_t * pk, const unsigned char *w, const unsigned char gf16mul_lut[256] );
